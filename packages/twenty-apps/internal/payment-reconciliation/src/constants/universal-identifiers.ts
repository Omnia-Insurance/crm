...
export const APP_UNIVERSAL_IDENTIFIER =
  'd11726da-5de9-4482-a2b0-68dc18d25181';
export const DEFAULT_ROLE_UNIVERSAL_ID =
  '297ed85c-98d1-4362-a790-d9f56be159a8';

// Objects
export const CARRIER_CONFIG_OBJECT_ID =
  '84629565-14f4-4578-a4c3-c514d6aef4a6';
export const SOURCE_FILE_OBJECT_ID =
...
export const CC_CARRIER_CRM_ID_FIELD_ID =
  'a0e2ebaf-6a21-4628-8dba-347e8d0f14c5';
export const CC_PARSER_ID_FIELD_ID =
  '3e803b41-7bcc-4559-a53c-213acd79cd63';
export const CC_BOB_COLUMN_MAPPING_FIELD_ID =
  '9774910b-06a2-47ed-9564-92ae8cd3cb6f';
export const CC_STATUS_MAPPING_CONFIG_FIELD_ID =
  'e3eb53cf-098a-43c8-b57d-8b8682f44318';
export const CC_PMPM_SCHEDULE_FIELD_ID =
  'c96198cd-3a36-48e4-ad6a-26a1a5f700fd';
export const CC_PAYMENT_LAG_DAYS_FIELD_ID =
  '54548ebe-a9c5-443b-847f-7c770e2f5e81';
export const CC_AUDIT_CONTACT_FIELD_ID =
  '068c1e36-80a4-49bf-9446-cd12366c755e';
...
export const SF_FILE_TYPE_FIELD_ID =
  '472b81d2-4e98-4a0d-9436-7fc80e1278ce';
export const SF_COVERAGE_MONTH_FIELD_ID =
  '1619a90c-4aa6-4e8f-8678-7d4028341ba0';
export const SF_UPLOADED_FILE_FIELD_ID =
  'a5e35bc3-ed74-40fa-964f-5239b92507aa';
export const SF_CHECKSUM_FIELD_ID =
  '0a4301ad-3132-4ed1-a6a1-7556844afab6';
export const SF_PARSE_STATUS_FIELD_ID =
  'ab3f6e43-a545-43b9-b417-48d7d6d78a32';
export const SF_SHEET_NAME_FIELD_ID =
  'bce32ae6-d055-4691-8760-9d77033a307f';
export const SF_PARSE_ERROR_FIELD_ID =
  '37a18d20-c91c-4535-a4f2-71478573ce23';
export const SF_TOTAL_ROWS_FIELD_ID =
  '605fd2e0-db2b-4e04-a1ce-c343ee75bb65';
export const SF_UPLOADED_AT_FIELD_ID =
  '85772594-7797-488e-8854-16df3cd00ca2';
export const SF_PARSED_AT_FIELD_ID =
  'fd6c1ec7-973d-415b-9851-aec05ddcfd03';

// NormalizedBookRow fields
export const NBR_NAME_FIELD_ID = '1533032f-e350-42ed-9b07-6502091f7f69';
export const NBR_ROW_NUMBER_FIELD_ID =
  '2f636cf3-bbef-4bf8-bb8a-8ae30afca522';
export const NBR_CARRIER_POLICY_NUMBER_FIELD_ID =
  '2bf8b24b-57c9-4ec5-92a5-dfaa96b7cc64';
export const NBR_SUBSCRIBER_NUMBER_FIELD_ID =
  'c5eb5606-fd47-486d-9a20-ce3b554eab52';
export const NBR_MEMBER_FIRST_NAME_FIELD_ID =
  '2b7f3bb1-9686-4d54-a7d3-71b94b5c5cd6';
export const NBR_MEMBER_LAST_NAME_FIELD_ID =
  '157b755c-0255-4f94-905b-1c6b367bba1e';
export const NBR_MEMBER_DOB_FIELD_ID =
  '4867dd49-31e1-4909-9190-ff28f5b8c401';
export const NBR_BROKER_NAME_FIELD_ID =
  'ec035f05-43ac-4120-b28e-34ce29879402';
export const NBR_BROKER_EFFECTIVE_DATE_FIELD_ID =
  'eb5efb24-786e-4843-a8ff-6ca173431c98';
export const NBR_POLICY_EFFECTIVE_DATE_FIELD_ID =
  'bc47d61d-8e7a-4dfe-830b-834ff08abcb2';
export const NBR_TRUE_EFFECTIVE_DATE_FIELD_ID =
  '3a44730c-e2a0-4a8c-a7c6-fb2b5e5dbe9a';
export const NBR_PAID_THROUGH_DATE_FIELD_ID =
  'a5d82eb1-1fbc-4776-8b13-3dec0891eb5d';
export const NBR_TERM_DATE_FIELD_ID =
  '4b1673ae-4b69-49e8-abd8-3c8566d732f3';
export const NBR_ELIGIBLE_FOR_COMMISSION_FIELD_ID =
  '09ef9202-54e2-4042-94e2-2585feabb910';
export const NBR_NUMBER_OF_MEMBERS_FIELD_ID =
  '4f6f9f83-cfb0-4b85-952b-33f1c4eaa95e';
export const NBR_PLAN_NAME_FIELD_ID =
  'b8ba44de-7991-4ae8-bb2c-e2ad658fc09b';
export const NBR_MONTHLY_PREMIUM_FIELD_ID =
  '4356928e-e002-48b8-bfe0-8181ae9adf33';
export const NBR_MEMBER_RESPONSIBILITY_FIELD_ID =
  '5283aa7a-c01e-4b67-872e-30fb3bd1ff4d';
export const NBR_MEMBER_PHONE_FIELD_ID =
  '7cbc37c6-5007-452e-95b9-e28d1afed30d';
export const NBR_MEMBER_EMAIL_FIELD_ID =
  'd55b8253-c10a-4f0f-bd5d-b641476ef36e';
export const NBR_EXCHANGE_SUBSCRIBER_ID_FIELD_ID =
  'cec0b2de-8777-47bf-b9e3-95c718449fa8';
export const NBR_BROKER_NPN_FIELD_ID =
  'd50e7e4a-e567-411f-b4b2-3299df1a69b6';
export const NBR_PAYABLE_AGENT_FIELD_ID =
  '6d3ad6b3-a27f-4619-adcb-ff1b2488c0ad';
export const NBR_ON_OFF_EXCHANGE_FIELD_ID =
  'a0490414-b654-43dc-993f-b5c38b22c282';
export const NBR_COUNTY_FIELD_ID =
  '305c7b13-48e3-4c9d-852d-5467741f56dc';
export const NBR_STATE_FIELD_ID =
  'a7f1b80a-84c0-406e-bd0f-6b1242e9423e';
...
export const MR_CONFIDENCE_FIELD_ID =
  '8f9d3494-194a-417c-888e-c241da3cd315';
export const MR_MATCH_METHOD_FIELD_ID =
  '122ba1aa-3bd7-4e18-9558-ec4bd6466d1d';
export const MR_MATCH_STATUS_FIELD_ID =
  '54e3263e-eb66-494e-830f-8d18a1d096a5';
export const MR_MATCH_NOTES_FIELD_ID =
